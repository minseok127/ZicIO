...
The original ZicIO used a 4MB buffer to cache ext4_extent. My initial focus was on avoiding extra resource overhead over the previous implementation. So I started creating a mapping table that uses buffer position as a key to retrieve the information needed for I/O for the given position, while maintaining this amount of memory.
