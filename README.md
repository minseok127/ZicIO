...
The original ZicIO used a 4MB buffer to cache ext4_extent. My initial focus was on avoiding extra resource overhead over the previous implementation. With this amount of memory, I began creating a mapping table to obtain the information needed for I/O at each buffer position.
